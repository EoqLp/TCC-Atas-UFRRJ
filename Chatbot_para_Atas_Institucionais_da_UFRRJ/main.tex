...
\title{Chatbot para Atas Institucionais da UFRRJ}

% autor é obrigatório; máximo de 3 autores
\author{Felipe Rangel da Silva}{\input{elementos-pretextuais/agradecimentos}}
\author{Gabriel Perez Vargas de Vasconcelos}{\input{elementos-pretextuais/agradecimentos}}
%\author{Nome completo aluno 3}{\input{elementos-pretextuais/agradecimentos}}

% orientador é obrigatório
\advisor[Prof.]{Ubiratam Carvalho de Paula Jr,~D.Sc.}{}
% \advisor[Prof.]{Nome completo,~D.Sc.}{}{a} % orientadora

% co-orientador é opcional
\coadvisor[Prof.]{Fellipe Ribeiro Duarte,~D.Sc.}{}
...
\banca[Prof.]{Bruno Jose Dembogurski,~D.Sc.}{DCC~-~UFRRJ}
\banca[Prof.]{Marcel William Rocha da Silva,~D.Sc.}{DCC~-~UFRRJ}
